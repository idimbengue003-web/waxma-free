    ...
    <header className="bg-wakhma-primary/95 backdrop-blur-md sticky top-0 z-50 border-b border-wakhma-accent/20">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <a href="#/recharge" className="flex items-center gap-2 bg-wakhma-highlight/10 text-wakhma-highlight border border-wakhma-highlight/20 px-4 py-2 rounded-xl text-sm font-bold hover:bg-wakhma-highlight/20 transition">
        ...
        <div className="md:hidden flex items-center gap-3">
          ...
          <a href="#/recharge" className="flex items-center gap-1.5 bg-wakhma-highlight/10 text-wakhma-highlight border border-wakhma-highlight/20 px-3 py-1.5 rounded-lg text-xs font-bold">
            💎 Points
          </a>
      ...
      {menuOpen && (
        <div className="md:hidden bg-wakhma-secondary border-t border-wakhma-accent/20 animate-fade-in-up">
          <nav className="flex flex-col p-6 gap-3">
            ...
            <a href="#/recharge" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 text-wakhma-highlight font-bold py-3 px-5 rounded-xl bg-wakhma-highlight/10 border border-wakhma-highlight/20 text-sm">💎 Acheter des points</a>
